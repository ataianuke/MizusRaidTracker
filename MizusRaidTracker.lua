...
local MRT_Defaults = {
    ["Options"] = {
        ...
        ["General_PrunningTime"] = 120,                                              -- Prunning time, after log shall be deleted (days)
        ["General_ShowMinimapIcon"] = false,                                        --
        ["Attendance_GuildAttendanceCheckEnabled"] = false,                         -- 
        ["Attendance_GuildAttendanceCheckNoAuto"] = false,                           --
        ...
        ["Tracking_LogLFRRaids"] = false,                                            -- Track LFR raids: true / nil (any)
        ...
        ["Tracking_AskCostAutoFocus"] = 3,                                          -- 1: always AutoFocus, 2: when not in combat, 3: never
        ["Tracking_CreateNewRaidOnNewZone"] = false,
        ["Tracking_OnlyTrackItemsAboveILvl"] = 0,
        ["Tracking_UseServerTime"] = true,
        ...
        ["Export_CTRT_IgnorePerBossAttendance"] = true,                            -- This will create an export where each raid member has 100% attendance: true / nil
