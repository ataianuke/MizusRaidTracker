...
---------------------------------
MRT_L.Core = @localization(locale="deDE", format="lua_table", handle-unlocalized="comment", namespace="MRT_L/Core")@


-----------------------------------
--  Option panels local strings  --
-----------------------------------
MRT_L.Options = @localization(locale="deDE", format="lua_table", handle-unlocalized="comment", namespace="MRT_L/Options")@


-------------------
--  GUI strings  --
-------------------
MRT_L.GUI = @localization(locale="deDE", format="lua_table", handle-unlocalized="comment", namespace="MRT_L/GUI")@
