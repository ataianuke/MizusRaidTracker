...
-- LibEPGP_GPCalculator:GetItemGP("item:50717:0:0:0:0:0:0:0:0", "PRIEST") == { 778 }, nil, nil, nil
...
-- LibEPGP_GPCalculator.GetItemGP(50412, "WARRIOR") => { 825, 275 }, "Either 275 GP (for Hunter or Tank or if used as Offhand) or 825 GP (for anything else)", "1HWEAPON", { ["OTHER"] = 825, ["OFFHAND"] = 275, ["TANK"] = 275, ["HUNTER"] = 275 }
-- @usage Example 3: A T10-Token - two possible GP values, depending on the slot - ItemID is given
-- LibEPGP_GPCalculator.GetItemGP(52030) => { 778, 583 }, "Either 778 GP (for Head, Chest or Legs) or 583 GP (for Shoulders or Hands)", "TOKEN", { ["HEAD"] = 778, ["CHEST"] = 778, ["LEGS"] = 778, ["SHOULDERS"] = 583, ["HANDS"] = 583, }
-- @usage Example 4: A bag - no possible values - ItemId is given
-- LibEPGP_GPCalculator.GetItemGP(38082) => { 0 }, nil, nil, nil
    ...
    if LBIR[itemType] == "Miscellaneous" then
        ...
        if TOKEN_5PART[itemID] then
            ...
            elseif slot == "INVTYPE_SHOULDER" or slot == "INVTYPE_HAND" then
                ...
                local GPValues = { lib:GetGP(itemLevel, itemRarity, 1), lib:GetGP(itemLevel, itemRarity, 0.75) }
