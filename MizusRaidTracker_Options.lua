...
-- variable to store the options panel frame, in order to be able to adress this in MizusRaidTracker.lua for the new OpenToCategory
mrt.optionspanelparent = nil;
